...
export interface Journal {
  ...
  user_name?: string;
  user_class?: string;
  mood: string; // 'Sangat Senang' | 'Senang' | 'Biasa Saja' | 'Cemas' | 'Sedih' | 'Lelah' | 'Marah'
  title: string;
  feeling: string;
  problems?: string;
...
export interface CareerContent {
  id: string;
  title: string;
  category: string; // Dunia Kerja, Kuliah, PKL, Wirausaha, Persiapan CV, Persiapan Interview, Lowongan, Jurusan Kuliah, Perencanaan
  content: string;
  summary: string;
  tags: string[];
  source_url?: string;
